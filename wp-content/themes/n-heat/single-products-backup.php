            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="product-content">
                        ...
                        <?php if (have_rows('bojler_energetska_vrednost')) : ?>
                            <?php while (have_rows('bojler_energetska_vrednost')) : the_row();

                                // Get sub field values.
                                $slika_mala = get_sub_field('mala_slika');
                                $slika_velika = get_sub_field('velika_slika');

                            ?>
                                <div class="bojler-energetska">
                                    <h4>Da biste videli energetske <br> nalepnice kliknite na sliku <img class="mala_slika" src="<?php echo esc_url($slika_mala['url']); ?>" alt="<?php echo esc_attr($slika_mala['alt']); ?>" /></h4>

                                    <img class="velika_slika" src="<?php echo esc_url($slika_velika['url']); ?>" alt="<?php echo esc_attr($slika_velika['alt']); ?>" />
                                </div>
